...
void plotNTopsFullTMatch_WithTau(){
    TFile *file40EtaCut = new TFile("workspaces/prod220222_1M_run230818_fix_pt20_eta40/jet_observables.root", "READ");
    TFile *file25EtaCut = new TFile("workspaces/prod220222_1M_run230818_fix_Tau_pt20_eta40/jet_observables.root", "READ");
    ...
    legend->SetHeader("Leptons considered", "C");
    ...
    // Save canvas
    canvas->SaveAs("plots/plot_230818_fix_Tau_numberofTopsFullTMatch.pdf");
